import {
  ...
  classSignature,
  computedStyleLooksPaged,
  forcedTitleSignal,
  forcedVisualSignal,
  forcedSlideCandidate,
  forcedSlideContentElement,
  forcedSlidesShouldReplaceExisting,
  hasDeckContainerHint,
  hasForcedWrapperHint,
  hasNonSlideChromeHint,
  hasRepeatedSiblingShape,
  hasSlideItemHint,
  hasTokenMatch,
  forcedSlideScore,
  forcedSlideStrongSignal,
  inferForcedDeckSlides,
  inferForcedDeckSlidesFromAll,
...
function bridgeHelperSource() {
  return [
    ...
    computedStyleLooksPaged.toString(),
    forcedVisualSignal.toString(),
    forcedTitleSignal.toString(),
    ...
    forcedSlideStrongSignal.toString(),
    forcedSlideCandidate.toString(),
    hasForcedWrapperHint.toString(),
    forcedSlideContentElement.toString(),
    pruneForcedSlideCandidates.toString(),
    inferForcedDeckSlidesFromAll.toString(),
